...
namespace C14_Ex01
{
    public partial class MainForm : Form
    {
        ...
        private void setMeProfilePanel()
        {
            ...
            placeTaggedInPhotosPicturesOnPictureBox();
        }
        ...
        {
            fetchEventsList(m_Manger.ConnectToFacebook().LoggedInUser, checkedListBoxEvents);
        ...
        private void buttonSend_Click(object sender, EventArgs e)
        {
            ...
            foreach (Event item in checkedListBoxEvents.SelectedItems)
            {
                selectedEvent.Add(item);
            }

            m_ReminderManufacturer.Construct(m_ReminderBuilder, richTextBoxMailSubject.Text, richTextBoxMailContent.Text, selectedEvent, m_Manger.ConnectToFacebook().LoggedInUser.Email);
            m_ReminderBuilder.Invite.sendUserEventsReminder();
        }
